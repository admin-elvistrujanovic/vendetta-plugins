module.exports = class Patcher {
  ...
  static resolveModule(module) {
    ...
    if (typeof module === 'string') {
      return VendettaModules[module] || BdApi[module];
    }
    if (Array.isArray(module)) {
      return VendettaAPI.findByUniqueProperties(...module) || BdApi.findByUniqueProperties(...module);
    }
    return null;
  }
  ...
  static pushChildPatch(caller, module, functionName, callback, options = {}) {
    ...
    const child = {
      ...
      id: patch.counter,
      callback,
      unpatch: (VendettaAPI.monkeyPatch || BdApi.monkeyPatch)(mdl, functionName, { [type]: data => {
